...
<div class="col-sm-12">
    ...
    <br>
        ...
        @endif
         ...
         <div class="col-sm-4 movedown">
        <img src="imagesIntegration/paypal-logo.png" width="70%" align="center" alt=""> <br>
             <form action="{{route('integration.revoke-access')}}" method="POST">
                    {{ csrf_field() }}
                    <input type="submit" value="Unlink PayPal" class="btn btn-warning movedown">
            </form>
<!-- 
            <a href="{{$google_drive_auth_url}}"><button {{$filesystem_integration ? 'disabled' : ''}} class="btn btn-md btn-brand movedown">Link PayPal</button></a> -->
        </div>
    </div>
</div>
