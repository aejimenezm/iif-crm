...
@section('heading')
    {{ __('Create event') }} <span class="small">{{$client ? '(' . $client->company_name . ')': ''}}</span>
@stop
                    ...
                    <div class="tablet__body">
                        ...
                        <div class="form-inline">
                            <div class="form-group col-sm-7" style="padding-left: 0px;">
                                <label for="deadline" class="control-label thin-weight">@lang('Date')</label>
                        ...
                        {{csrf_field()}}
                        <div class="form-group">
                            <input type="submit" class="btn btn-md btn-brand movedown" id="createTask" value="{{__('Create event')}}">
                        </div>
                    </div>
                </div>
            </div>
